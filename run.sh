...
startPeer() {
    ...
    export PATH=/home/setup/config/peer:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
...
startOrderer() {
    ...
    export PATH=/home/setup/config/orderer:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
